...
// sessionAsyncPaymentSucceeded handles delayed payment methods that confirm
// after the checkout session has already completed.
...
// sessionAsyncPaymentFailed marks orders as failed when delayed payment
// methods ultimately fail.
...
// fulfillOrder handles the shared quota-crediting flow once Stripe payment is confirmed.
